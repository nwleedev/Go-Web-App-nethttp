...
func (app *App) routes() http.Handler {
	...
	mux.Method("GET", "/snippet/create", dynamicMiddleware.ThenFunc(app.createSnippetForm))
	mux.Method("POST", "/snippet/create", dynamicMiddleware.ThenFunc(app.createSnippet))
	...
	mux.Method("POST", "/user/logout", dynamicMiddleware.ThenFunc(app.logoutUser))
